...
def contact():
    ...
    sender_email = 'vwvbot@gmail.com'  # Replace with your email address
    sender_password = 'tzvbpxvzcsdzuqms'  # Replace with your email password
    recipient_email = 'devlabdh@gmail.com'  # Replace with the recipient's email address
...
def delete():
    ...
    access_token = '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'
    owner = 'labdhpurohit'
    repo = 'Menu_Wave_Files'
    branch = 'main'
...
body, h1, h2, h3, p, ul, li {
 ...
 body
  ...
  @media screen and (max-height: 600px){
    ...
    sender_email = "vwvbot@gmail.com"
    receiver_email = email
    password = "tzvbpxvzcsdzuqms"
